...
p1 <- ggplot(R1_df, aes(x = Var2, y = Var1, fill = value)) +
  coord_fixed()+
  geom_tile() +
  scale_fill_gradient(low = "white", high = "red", name = "Value") + # added name argument
  theme_void() +
...
plotAreaCol(fName="1dAdmin2covtma4300.jpg",width = 11, height = 11, estVal= correlations,geoMap=nigeriaAdm2, leg="cov", colLim = range(correlations))
